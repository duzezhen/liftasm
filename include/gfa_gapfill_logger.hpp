...
public:
    ...
    static void refined_boundary(const std::string& left, uint64_t left_cut, const std::string& right, uint64_t right_cut, uint64_t right_length, const std::string& bridge, uint64_t bridge_begin, uint64_t bridge_end, const BoundarySupport& left_support, const BoundarySupport& right_support, double left_alignment, double right_alignment);
